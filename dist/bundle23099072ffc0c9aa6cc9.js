...
var Project = /*#__PURE__*/function () {
  ...
  _createClass(Project, [{
    ...
    value: function addTask(task) {
      var taskObj = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](task);
...
var Storage = /*#__PURE__*/function () {
  ...
  _createClass(Storage, [{
    ...
    value: function getTodoList() {
      var todoList = Object.assign(this.todoList, JSON.parse(localStorage.getItem('todoList')));
      return todoList;
    }
  }, {
    key: "addDefaultProject",
    value: function addDefaultProject() {
      var hasDefaultProject = false;
      this.todoList.getProjects().forEach(function (project) {
    ...
    value: function addProject(project) {
      var _console;
      /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("9ce3d48a_0", this.todoList.addProject(project))));
    ...
    value: function getProject(name) {
      var project = this.todoList.getProject(name);
      return new _Project__WEBPACK_IMPORTED_MODULE_1__["default"](project.title);
    }
  }, {
    key: "addTask",
    value: function addTask(project, task) {
      // console.log(project);
...
var TodoList = /*#__PURE__*/function () {
  ...
  _createClass(TodoList, [{
    ...
    value: function addProject(title) {
      var project = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"](title);
...
var UI = /*#__PURE__*/function () {
  ...
  _createClass(UI, [{
    ...
    value: function addTask() {
      ...
      var selectedProject = this.storage.getProject(document.querySelector('.selected').children[1].textContent);
    ...
    value: function loadProjects() {
      ...
      projects.forEach(function (project) {
        _this.createProject(project.title);
      });
    }
    ...
    value: function initButtons() {
      ...
      projectsListContainer.addEventListener('click', function (e) {
        ...
        if (btn.dataset.hasOwnProperty('project')) {
          var projectName = btn.children[1].textContent;
          _this2.previewProject(_this2.storage.getProject(projectName));
...
/******/ })()
;
//# sourceMappingURL=bundle23099072ffc0c9aa6cc9.js.map